...
import type { User as AppUser, Course, CartItem, WishlistItem, EBook, Subscription, Book } from '@/lib/types';
...
interface CartContextType {
  cartItems: CartItem[];
  addToCart: (item: Course | EBook | Subscription | Book, type: 'course' | 'ebook' | 'subscription' | 'book') => void;
  removeFromCart: (itemId: string, type: 'course' | 'ebook' | 'subscription' | 'book') => void;
  clearCart: () => void;
  subtotal: number;
  total: number;
}
...
interface WishlistContextType {
  ...
  addToWishlist: (item: Course | EBook | Subscription | Book, type: 'course' | 'ebook' | 'subscription' | 'book') => void;
  removeFromWishlist: (itemId: string, type: 'course' | 'ebook' | 'subscription' | 'book') => void;
}
...
const WishlistProvider = ({ children }: { children: ReactNode }) => {
    ...
    const addToWishlist = useCallback((item: Course | EBook | Subscription | Book, type: 'course' | 'ebook' | 'subscription' | 'book') => {
    ...
    const removeFromWishlist = useCallback((itemId: string, type: 'course' | 'ebook' | 'subscription' | 'book') => {
