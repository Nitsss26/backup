...
const Caro = () => {
        ...
        sideDeals: [
           ...
           //   url: "https://games.capcomusa.com/#118170", // optional, empty means no redirect
            },
            {
              ...
              discount: "",
              platforms: ["", "", ""],
              image:"https://st.adda247.com/https://storeimages.adda247.com/WhatsAppImage20250502at84006PM1746244686.jpeg?tr=w-250",
  ...
  onClick={() => window.location.href = 'https://my.newtonschool.co/cs/newton-headstart?registration-flow-type=default&next=/cs/newton-headstart/select-course&video_recording_hash=head_start_intro_video'}
>
