...
// //   if (items.length === 0) {
// //     return (
// //       <div className="relative bg-muted flex items-center justify-center h-[400px] md:rounded-xl md:shadow-2xl">
...
// //   return (
// //     <div className="relative overflow-hidden md:rounded-xl md:shadow-2xl">
// //       <div className="flex transition-transform duration-500 ease-in-out" style={{ transform: `translateX(-${currentSlide * 100}%)` }}>
// //         {items.map((item, index) => (
// //           <div key={item.id} className="min-w-full">
// //             <div className="relative">
...
// //                 width={1200}
// //                 height={400}
// //                 className="w-full h-[390px] md:h-[400px]"
// //                 priority={index === 0}
// //                 data-ai-hint="course promotion banner"
// //               />
            ...
            <div className="relative mt-5">
              ...
              {item.mobileImageUrl && (
                <Image
                  ...
                  width={1200}
                  height={250}
                  className="w-full h-[250px] object-cover block md:hidden"
                  priority={index === 0}
