...
//           <DropdownMenu>
//             <Button variant="ghost" className="flex text-foreground/70 hover:text-foreground transition-colors -mr-10">
//                 <Home className="h-4 w-4 text-foreground/70 hover:text-foreground transition-colors" href={`/`}/> Home
//               </Button>
//             <DropdownMenuTrigger asChild>
//               <Button variant="ghost" className="flex items-center gap-1 text-foreground/70 hover:text-foreground transition-colors -mr-5">
//                 <LayoutGrid className="h-4 w-4 text-foreground/70 hover:text-foreground transition-colors " /> Categories
//               </Button>
//             </DropdownMenuTrigger>
//             <DropdownMenuContent align="start">
//               {CATEGORIES.map((category) => (
//                 <DropdownMenuItem key={category.id} asChild>
//                   <Link className="text-foreground/70 hover:text-foreground transition-colors" href={`/courses?category=${category.slug}`}>{category.name}</Link>
//                 </DropdownMenuItem>
//               ))}
//             </DropdownMenuContent>
//           </DropdownMenu>
