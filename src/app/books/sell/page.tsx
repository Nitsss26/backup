...
// import { Loader2, BookUp, MapPin, UploadCloud, CheckCircle, X, AlertTriangle } from 'lucide-react';
...
//         setLocationError(error.message || "Could not fetch current location. Please select location manually.");
//         toast({ 
//           title: "Location Error", 
//           description: error.message || "Could not fetch current location. Please select location manually.", 
//           variant: "destructive" 
//         });
//     }
//   };
...
//                    <AlertDescription>
//                     {locationError} You must allow location access or manually set a location to list a book.
//                    </AlertDescription>
//                  </Alert>
//                )}
...
//             <Button type="submit" className="w-full" disabled={isLoading || isUploading || !!locationError}>
//               {isLoading ? (
//                 <>
  ...
  const handleUseCurrentLocation = async () => {
    ...
    if (!location) {
      toast({
        ...
        description: "You denied location permission. Please enable location services or select a location manually.",
        variant: "destructive",
      });
      return;
    }
