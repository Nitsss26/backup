...
const chartConfig = {
  ...
  profit: { label: "Profit (₹)", color: "hsl(var(--success))" }, // Green for profit
...
export default function AdminDashboardPage() {
  ...
  const managementTools = [
    ...
    {label: "System Analytics", href: "/admin/analytics", icon: BarChartIcon, description: "Platform-wide analytics.", color: "indigo", iconColor: "text-indigo-600 dark:text-indigo-400", bgColor: "bg-indigo-50 dark:bg-indigo-900/40"},
  ...
  return (
    <div className="space-y-8 p-2 md:p-0 max-w-screen-xl mx-auto"> {/* Applied max-w and mx-auto */}
