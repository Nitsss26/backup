    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto">
            ...
            <div className="relative">
              <div className="overflow-x-auto no-scrollbar">
                <div className="flex gap-4 py-2" style={{ minWidth: '100%' }}>
                  {platforms.map((platform, index) => (
                    <div key={platform.name} className="flex-shrink-0 w-1/3 sm:w-1/4 md:w-auto">
                      <Link href={platform.ctaLink}>
                        <div className="bg-[--bg-dark] rounded-xl p-3 sm:p-4 border-2 border-[--border-color] transition-all duration-300 cursor-pointer h-28 sm:h-36 flex flex-col items-center justify-center group hover:border-[#5593f7] hover:shadow-xl hover:shadow-[#5593f7]/20 hover:scale-[1.02] hover:z-10">
                          ...
                          <span className="text-[--text-light] text-sm sm:text-base font-medium text-center group-hover:text-[#5593f7] transition-colors duration-300 leading-tight">
                            {platform.name}
                          </span>
                        </div>
                      </Link>
            ...
            <div className="overflow-x-auto no-scrollbar">
              <div className="flex gap-4 py-2" style={{ minWidth: '100%' }}>
                {topCategoryShowcaseData
                  ...
                  .slice(0, 5)
                  .map((course) => (
                    <div key={course.id} className="flex-shrink-0 w-1/2 sm:w-1/3 md:w-auto">
        ...
        <section className="py-12 px-4 sm:px-6 bg-gradient-to-r from-[--primary-blue] to-[#5593f7] section-divider">
          <div className="container mx-auto flex flex-col md:flex-row justify-between items-center rounded-xl p-4 sm:p-8">
            <motion.div
            ...
            <div className="overflow-x-auto no-scrollbar">
              <div className="flex gap-4 py-2" style={{ minWidth: '100%' }}>
                {[
                  ...
                  <div key={bundle.id} className="flex-shrink-0 w-1/2 sm:w-1/3 md:w-auto">
                    <CourseCard course={bundle as any} />
                  </div>
                ))}
              </div>
            </div>
        ...
        <section className="py-12 px-4 sm:px-6 bg-[--bg-dark] section-divider">
          <div className="container mx-auto">
            ...
            <div className="overflow-x-auto no-scrollbar">
              <div className="flex gap-2 sm:gap-4 py-2" style={{ minWidth: '100%' }}>
                {CATEGORIES.slice(0, 7).map((category) => (
                  <div key={category.id} className="flex-shrink-0 w-1/3 sm:w-1/4 md:w-auto">
                    <CategoryCard
                      name={category.name}
                      slug={category.slug}
                      bgColor="bg-[--bg-light]"
            ...
            <div className="overflow-x-auto no-scrollbar">
              <div className="flex gap-4 py-2" style={{ minWidth: '100%' }}>
                {[
                  ...
                  <div key={addon.id} className="flex-shrink-0 w-1/2 sm:w-1/3 md:w-auto">
              ...
              {[
                ...
                >
                  <Link href={price.href}>
                    <Button className="w-full bg-[--bg-light] text-[--text-light] py-2 sm:py-3 rounded-lg font-semibold hover:bg-[#5593f7] transition-colors shadow-md">
                      {price.label}
                    </Button>
                  </Link>
                </motion.div>
        ...
        <section className="py-12 px-4 sm:px-6 bg-primary/10 section-divider">
          <div className="container mx-auto text-center">
            ...
            <motion.p
              className="text-lg text-gray-300 mb-4 sm:mb-6"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            >
              ...
              <Button type="submit" className="bg-[--primary-blue] text-[--text-light] px-4 sm:px-6 py-2 sm:py-3 rounded-full font-semibold hover:bg-[#5593f7] transition-colors w-full sm:w-auto">
                Subscribe
              </Button>
            </motion.form>
            <motion.p
              className="text-gray-400 mt-2 sm:mt-4 text-sm"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            <div className="overflow-x-auto no-scrollbar">
              <div className="flex gap-4 py-2" style={{ minWidth: '100%' }}>
                {[
                  ...
                  <div key={sub.id} className="flex-shrink-0 w-1/2 sm:w-1/3 md:w-auto">
