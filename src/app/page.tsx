...
export default function HomePage() {
  ...
  const categoryColors = [
    'text-blue-600',     // Technology/Programming
    'text-green-600',    // Business/Finance
    'text-purple-600',   // Arts/Creative
    'text-red-600',      // Health/Medical
    'text-orange-600',   // Engineering
    'text-pink-600',     // Design
    'text-teal-600',     // Science
    'text-indigo-600',   // Education
    'text-yellow-600',   // Marketing
    'text-cyan-600',     // Language
    'text-emerald-600',  // Sports/Fitness
    'text-rose-600',     // Music
    'text-violet-600',   // Photography
    'text-amber-600',    // Cooking
    'text-lime-600',     // Environment
    'text-sky-600',      // Aviation/Travel
    'text-fuchsia-600',  // Fashion
    'text-slate-600',    // General
  ];
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        {/* Hero Section */}
        <section className="py-16 md:py-24 lg:py-32 bg-secondary/30 -mt-9">
          ...
          <div className="container">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <Card
                  key={index}
                  className="text-center hover:shadow-xl transition-shadow duration-300 border-t-4 border-primary bg-card"
                >
        ...
        {/* <section className="py-16 md:py-20 bg-secondary/30">
          <div className="container">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 md:mb-16 font-headline">
              How {APP_NAME} Works
            </h2>
            <div className="grid md:grid-cols-2 gap-10 items-start">
              <Card className="shadow-lg border-primary border-2 h-full">
                ...
                <CardContent className="pl-10 pb-6 mt-auto">
                  <Image
                    ...
                    alt="Illustration of a student learning journey, with icons for discovery, comparison, enrollment, and achievement"
                    width={400}
                    height={250}
              ...
              <Card className="shadow-lg border-accent border-2 h-full">
                ...
                <CardContent className="pl-10 pb-6 mt-auto">
                  <Image
                    src="https://placehold.co/400x250.png"
                    alt="Illustration of seller tools, course creation interface, and growth charts"
                    width={400}
                    height={250}
                    className="rounded-md shadow"
                ...
                <div key={categoryData.categorySlug} className="mb-12 last:mb-0">
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 md:mb-8">
                    <h3 className="text-2xl font-semibold flex items-center mb-2 sm:mb-0">
                      {categoryDetails?.icon && <categoryDetails.icon className="h-8 w-8 text-primary mr-3" />}{' '}
                      {categoryData.categoryName}
                    </h3>
                    <Button
                      variant="link"
                      asChild
                      className="text-primary self-start sm:self-center hover:text-primary/80"
                    >
              ...
              {CATEGORIES.map((category, index) => (
                <Link key={category.id} href={`/courses?category=${category.slug}`}>
                  <div className="group bg-card p-4 md:p-6 rounded-lg shadow-md hover:shadow-xl hover:border-primary border-2 border-sky-200 transition-all text-center aspect-square flex flex-col justify-center items-center transform hover:-translate-y-1.5 duration-300">
                    ...
                    <h3 className="text-sm md:text-base font-semibold group-hover:text-primary transition-colors line-clamp-2">
                      {category.name}
                    </h3>
                  </div>
                </Link>
              ...
              {[
                {
                  ...
                  image:
                    "https://plus.unsplash.com/premium_photo-1682089810582-f7b200217b67?w=100&h=100&fit=crop&crop=face&auto=format",
                ...
                <Card
                  key={i}
                  className="shadow-lg hover:shadow-xl transition-shadow duration-300 bg-card flex flex-col"
                >
                  <CardContent className="p-6 text-center flex flex-col flex-grow items-center">
                    <Image
                      ...
                      width={100}
                      height={100}
                      className="rounded-full mx-auto mb-5 border-4 border-primary/50 p-1 object-cover"
                    />
                    ...
                    <blockquote className="text-muted-foreground italic mb-4 text-sm leading-relaxed flex-grow">
                      "{testimonial.text}"
                    </blockquote>
...
//                   <div className="group bg-card p-4 md:p-6 rounded-lg shadow-md hover:shadow-xl hover:border-primary border-2 border-sky-200 transition-all text-center aspect-square flex flex-col justify-center items-center transform hover:-translate-y-1.5 duration-300">
//                     {category.icon && (
//                       <category.icon className="h-10 w-10 md:h-12 md:w-12 text-primary mb-3 group-hover:scale-110 transition-transform" />
//                     )}
//                     <h3 className="text-sm md:text-base font-semibold group-hover:text-primary transition-colors line-clamp-2">
//                       {category.name}
//                     </h3>
...
//                   imageHint: "indian student female happy",
//                   text: "The IIT-JEE course was intense but so well-structured! The mock tests were a game-changer. EdTechCart made finding it easy.",
//                 },
//                 {
//                   name: "Rohan Mehta",
//                   course: "Business Analytics Pro",
//                   image: "https://placehold.co/100x100.png",
//                   imageHint: "indian student male professional",
//                   text: "Upgraded my analytics skills significantly. The seller provided excellent support through the platform. User-friendly!",
//                 },
//                 {
//                   name: "Aisha Khan",
//                   course: "Advanced Python Programming",
//                   image: "https://placehold.co/100x100.png",
//                   imageHint: "indian student female coder",
//                   text: "Loved the Python course! The content was up-to-date, and I could learn at my own pace. Highly recommend this marketplace.",
//                 },
//               ].map((testimonial, i) => (
//                 <Card
