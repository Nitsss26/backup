...
import { PlusCircle, Trash2, UploadCloud, Loader2, Info } from 'lucide-react';
...
export default function NewCoursePage() {
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
      ...
      <Card className="border shadow-md">
        ...
        <CardContent className="space-y-6">
          <div>
            ...
            <Input id="title" {...register('title')} placeholder="e.g., The Complete Web Development Bootcamp"/>
            {errors.title && <p className="text-sm text-destructive mt-1">{errors.title.message}</p>}
          </div>
          <div>
            <Label htmlFor="shortDescription">Short Description (Max 150 chars) *</Label>
            <Textarea id="shortDescription" {...register('shortDescription')} maxLength={150} rows={2} placeholder="A brief, catchy summary of your course."/>
          ...
          <div>
            ...
            <Textarea id="description" {...register('description')} rows={5} placeholder="Detailed information about what students will learn, course structure, target audience, etc."/>
      ...
      <Card className="border shadow-md">
        <CardHeader><CardTitle>Pricing & Media</CardTitle><CardDescription>Set your course price and provide media URLs.</CardDescription></CardHeader>
        <CardContent className="space-y-6">
            <div className="grid md:grid-cols-3 gap-4">
                <div>
                ...
                <div>
                    ...
                    <Input id="moneyBackGuaranteeDays" type="number" {...register('moneyBackGuaranteeDays')} placeholder="e.g., 30"/>
             ...
             <div>
                ...
                <Input id="videoPreviewUrl" {...register('videoPreviewUrl')} placeholder="https://example.com/course_preview.mp4"/>
                    ...
                    <AccordionContent className="p-4 space-y-4 border-t">
                      ...
                      {watchCurriculum?.[moduleIndex]?.lessons?.[lessonIndex]?.type === 'text' && (
                        <div>
                            ...
                            <Textarea id={`textContent-${moduleIndex}-${lessonIndex}`} {...register(`curriculum.${moduleIndex}.lessons.${lessonIndex}.textContent`)} placeholder="Enter lesson content here... Markdown supported." rows={4}/>
                        </div>
                      )}
      ...
      <Card className="border shadow-md">
        <CardHeader>
            <CardTitle>Submission Guidelines & Review</CardTitle>
        </CardHeader>
        <CardContent className="space-y-3 text-sm text-muted-foreground">
            <div className="flex items-start gap-2 p-3 bg-blue-50 dark:bg-blue-900/30 rounded-md border border-blue-200 dark:border-blue-700">
                ...
                <p>
                Please ensure your course content is original, accurate, and adheres to our quality standards. All submitted courses undergo a review process by our admin team before being published on the marketplace. This may take a few business days. You will be notified of the outcome.
                </p>
            </div>
