  ...
  return (
    <SidebarProvider defaultOpen={shouldShowMainSidebar && !isStudentAreaWithHeaderNav}>
      <div className="flex flex-col min-h-screen">
        {/* Header positioned at top, sticky to avoid scrolling issues */}
        ...
        <div className="flex flex-1">
          {shouldShowMainSidebar && (
            ...
            >
              ...
              {/* <SidebarHeader className="p-2 flex justify-center opacity-100 group-hover:opacity-0 transition-opacity duration-300 group-[.w-16]:flex group-[.w-64]:hidden">
