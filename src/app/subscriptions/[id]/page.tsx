...
//                             <Image src={subscription.imageUrl} alt={subscription.title} width={800} height={600} className="rounded-t-lg object-cover w-full aspect-square" data-ai-hint="subscription service logo"/>
//                         </CardHeader>
...
//                         <Image src={subscription.imageUrl} alt={subscription.title} width={600} height={600} className="rounded-t-lg object-cover w-full aspect-square" data-ai-hint="subscription mobile"/>
//                     </CardHeader>
//                     <CardContent className="p-5 space-y-3">
//                         <div className="space-y-2">
//                             <Label>Choose Validity</Label>
...
//                             </>
//                         )}
//                         {subscription.purchaseInstructions && subscription.purchaseInstructions.length > 0 && (
//                             <>
//                                 <h3 className="font-semibold mt-6 mb-2 text-lg text-foreground col-span-full">Activation Instructions</h3>
...
import { useCart, useWishlist } from '@/components/AppProviders';
import { cn } from '@/lib/utils';
import { SubscriptionCard } from '@/components/SubscriptionCard2';
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger } from '@/components/ui/accordion';
import { Label } from '@/components/ui/label';
